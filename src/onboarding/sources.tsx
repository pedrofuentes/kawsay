...
const SOURCE_LIST: SourceMeta[] = [
  ...
  },
  {
    type: 'instagram',
    title: 'Instagram',
    description: 'Instagram direct messages, photos, videos & voice notes',
    icon: <Icon name="messages" className="h-6 w-6" />,
    pickerKind: 'file',
    walkthroughHeading: "Bringing in {name}'s Instagram messages",
    steps: [
      'On Instagram, open Accounts Center, then "Your information and permissions".',
      'Choose "Download your information" and select Messages in JSON format.',
      'Create the file and wait for Instagram to prepare it.',
      'Download the file and save it onto this computer.',
    ],
    locateLabel: 'Where is the Instagram file you saved?',
    locateHelper: 'It is usually a .zip file from Instagram, or an extracted folder.',
    locatePlaceholder: 'e.g. Downloads/instagram-…zip',
    reassurance: "You're just making a copy — nothing will be deleted from Instagram.",
  },
  {
    type: 'facebook',
    title: 'Facebook',
